...
public class Util {
	...
	/**
	 * Main function called from the Main class to solve the problem
	 * @param initial Initial installed packages
	 * @param toInstall List of packages to install or uninstall
	...
	/**
	 * Start method to solve dependencies and conflicts
	 * @param toInstall The packages to Install
	 * @param repo The repository of all packages, sorted in a new format
	 * @param initial Initial state
	 * @param toUninstall Packages to uninstall
	 */
